        ...
        public async static void Seeding(IApplicationBuilder app)
        {
            ...
            if(!await context.Services.AnyAsync())
            {
                context.Services.Add(new Service
                {
                    ...
                    NameEn = "Construction",
                    NameRu = "Construction",
                    TittleAz = "Sed sit amet sapien sit amet odio lobortis ullamcorper quis vel nisl. Nam blandit maximus tristique. Vivamus enim quam.",
                    TittleEn = "Sed sit amet sapien sit amet odio lobortis ullamcorper quis vel nisl. Nam blandit maximus tristique. Vivamus enim quam.",
                    TittleRu = "Sed sit amet sapien sit amet odio lobortis ullamcorper quis vel nisl. Nam blandit maximus tristique. Vivamus enim quam."
                });
            }
            ...
            if(!await context.Contacts.AnyAsync())
            {
                context.Contacts.Add(new Contact
                {
                    ...
                    ContentAz = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet iaculis elit. Nam semper ut arcu non placerat. Praesent nibh massa varius.",
                    ContentEn = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet iaculis elit. Nam semper ut arcu non placerat. Praesent nibh massa varius.",
                    ContentRu = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sit amet iaculis elit. Nam semper ut arcu non placerat. Praesent nibh massa varius.",
